...
define ("DB_USER", "onigbenga1"); // set database user
define ("DB_PASS","revelation1"); // set database password
define ("DB_NAME","electronicexam"); // set database name
...
if($existName=="") {
$insertTable= mysqli_query($link, "insert into YOUR_TABLE (name, email) values('".$userName."', '".$userMobile."');");
