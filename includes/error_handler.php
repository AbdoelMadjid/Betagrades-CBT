...
class ErrorHandler
{
    ...
    {
        // Reference class ErrorHandler and function Handler
    ...
    public static function Handler($errNo, $errStr, $errFile, $errLine)
    {
        ...
        /* The 2 parameter sent to GetBacktrace() specifies that the backtrace 
        results should omit the first two entries (the calls to ErrorHandler::Handler() 
        and ErrorHandler::GetBacktrace()).
        */
        ...
        know which of them should stop the execution of the request. The IS_WARNING_FATAL 
        constant set in config.php decides whether this type of error should be considered 
        fatal for the project. Also, errors of type E_NOTICE and E_USER_NOTICE are not considered fatal:
        */
        ...
        // If the error is nonfatal ...
        {
            ...
            // and error type isnt a notice
            if (DEBUGGING == true && $errNo != E_NOTICE)
